...
- Gain understanding of the need to empower everyone by designing inclusive systems
...
- **Stereotyping**. Associating a given group with pre-assigned attributes.  For example, a language translation system between English and Turkish may have inaccuracies due to words with stereotypical associations with gender.
...
- develop better methods throughout the machine learning lifecycle for detecting and correcting responsible AI when it occurs 
